...
CRITICAL: Always include the city/region in naverQuery and googleQuery.
- Use context clues to find the city/region (location tags, hashtags, text mentioning city name).
- For Korean places use Korean city names: 제주도, 서울, 부산, etc.
- naverQuery format: "place name city in Korean" e.g. "Planer House 제주도"
- googleQuery format: "place name city in English" e.g. "Planer House Jeju"

Respond ONLY with valid JSON array, no markdown:
[
  {"placeName":"name","city":"city","country":"country","naverQuery":"place + city in Korean","googleQuery":"place + city in English","confidence":"high"},
  ...
]
...
CRITICAL: Always include the city/region in naverQuery and googleQuery.
- If the post mentions a city or region (e.g. Jeju, Seoul, Tokyo), include it in EVERY place query.
- For Korean places use Korean: 제주도, 서울, 부산, etc.
- naverQuery format: "place name city in Korean" e.g. "Planer House 제주도"
- googleQuery format: "place name city in English" e.g. "Planer House Jeju"
